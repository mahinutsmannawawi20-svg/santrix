    ...
    <nav class="navbar">
        <div class="container navbar-content">
            ...
            <div style="display: flex; gap: 16px;">
                <a href="{{ route('tenant.login') }}" style="color: var(--text-dark); text-decoration: none; font-weight: 500; padding: 10px;">Masuk</a>
                <a href="{{ route('register.tenant') }}" class="btn-primary">Daftar Sekarang</a>
            </div>
        </div>
    </nav>
        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div style="display: flex; gap: 16px; justify-content: center;">
                    <a href="{{ route('register.tenant') }}" class="btn-primary" style="padding: 12px 32px; font-size: 1.1rem;">
                        Mulai Sekarang
                    </a>
        ...
        <div class="container">
            ...
            <div class="pricing-grid">
                ...
                <div class="pricing-card">
                    ...
                    <a href="{{ route('register.tenant') }}" class="btn-primary btn-block">Pilih Paket</a>
                </div>
                ...
                <div class="pricing-card featured">
                    ...
                    <a href="{{ route('register.tenant') }}" class="btn-primary btn-block">Coba Gratis 14 Hari</a>
                </div>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="footer-bottom">
                &copy; {{ date('Y') }} SANTRIX. All rights reserved. Made with ❤️ for Pesantren Indonesia.
            </div>
        </div>
    </footer>
