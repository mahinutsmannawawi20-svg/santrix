                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <div style="display: flex; gap: 6px; justify-content: center;">
                                    ...
                                    <form action="<?php echo e(route('sekretaris.mutasi-santri.destroy', $m->id)); ?>" method="POST" style="display: inline;" onsubmit="return confirmDelete(event, 'Data mutasi ini akan dihapus permanen.')">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\v\.gemini\antigravity\scratch\santrix\resources\views\sekretaris\mutasi\index.blade.php ENDPATH**/ ?>