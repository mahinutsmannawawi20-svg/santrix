...
<body style="margin: 0; padding: 0; background: #525659;">
    ...
    <div class="certificate-page">
        ...
        <div class="watermark-text"><?php echo e(strtoupper(tenant_name())); ?></div>
        <div class="watermark-text-2"><?php echo e(strtoupper(tenant_name())); ?></div>
        <div class="watermark-text-3"><?php echo e(strtoupper(tenant_name())); ?></div>
        ...
        <div class="content">
            <!-- Header with Logos -->
            <div class="header">
                <img src="<?php echo e(tenant_logo()); ?>" class="logo" alt="Logo Pesantren">
                
                <div class="header-text">
                    <div class="yayasan-name"><?php echo e(tenant()->nama ?? 'Yayasan Pondok Pesantren'); ?></div>
                    <div class="pondok-name"><?php echo e(tenant()->nama ?? 'Pondok Pesantren'); ?></div>
                    <div class="pondok-address"><?php echo e(tenant()->alamat ?? 'Alamat Pondok'); ?></div>
                </div>
                
                <?php if(tenant()->logo_pendidikan_url): ?>
                    <img src="<?php echo e(tenant()->logo_pendidikan_url); ?>" class="logo" alt="Logo Pendidikan">
                <?php else: ?>
                    <img src="<?php echo e(tenant_logo()); ?>" class="logo" alt="Logo">
                <?php endif; ?>
            </div>
            ...
            <div class="description">
                Telah menyelesaikan <?php echo e($jenjang); ?> pada <?php echo e(tenant()->nama ?? 'Pondok Pesantren'); ?>
            ...
            <div class="signatures">
                ...
                <div class="signature-box">
                    <div class="signature-title">
                        <?php echo e(tenant()->kota ?? 'Jombang'); ?>, <?php echo e($settings->tanggal_ijazah?->translatedFormat('d F Y') ?? now()->translatedFormat('d F Y')); ?><br>
                        <?php echo e(tenant()->pimpinan_jabatan ?? 'Pimpinan Umum'); ?>

                    </div>
                    <?php if(tenant()->pimpinan_ttd_path): ?>
                        <img src="<?php echo e(asset('storage/' . tenant()->pimpinan_ttd_path)); ?>" class="signature-image">
                    <?php else: ?>
                        <div style="height: 110px;"></div> 
                    <?php endif; ?>
                    <div class="signature-name"><?php echo e(tenant()->pimpinan_nama ?? '............................'); ?></div>
...
<?php /**PATH C:\Users\v\.gemini\antigravity\scratch\santrix\resources\views\pendidikan\ijazah\ijazah-pdf.blade.php ENDPATH**/ ?>