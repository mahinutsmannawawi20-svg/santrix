...
<head>
    ...
    <meta property="og:image" content="<?php echo e(asset('images/seo-og-image.jpg')); ?>">
    ...
    <meta property="twitter:image" content="<?php echo e(asset('images/seo-og-image.jpg')); ?>">
    ...
    <section id="home" class="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a href="<?php echo e(route('register.tenant')); ?>" class="w-full sm:w-auto px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white text-lg font-bold rounded-full shadow-xl hover:shadow-indigo-500/40 transition-all transform hover:-translate-y-1">
            ...
            <div class="mt-16 grid grid-cols-2 lg:grid-cols-3 gap-8 max-w-4xl mx-auto border-t border-slate-100 pt-10">
                <div class="text-center">
                    <div class="text-3xl font-bold text-slate-800"><?php echo e(number_format($stats['pesantren'])); ?>+</div>
                    <div class="text-sm text-slate-500 font-medium">Pesantren Bergabung</div>
                </div>
                <div class="text-center">
                    <div class="text-3xl font-bold text-slate-800"><?php echo e(number_format($stats['santri'])); ?>+</div>
    ...
    <section id="pricing" class="py-24 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
                ...
                <div class="relative bg-white rounded-3xl p-8 border <?php echo e($plan['is_featured'] ? 'border-indigo-600 shadow-2xl scale-105 z-10' : 'border-slate-100 shadow-lg'); ?> flex flex-col h-full transition-transform hover:-translate-y-2">
                    ...
                    <h3 class="text-xl font-bold text-slate-900 mb-2"><?php echo e($plan['name']); ?></h3>
                    <div class="flex items-baseline gap-1 mb-6">
                        <?php if(isset($plan['formatted_price'])): ?>
                            <span class="text-4xl font-extrabold text-slate-900"><?php echo e($plan['formatted_price']); ?></span>
                        <?php else: ?>
                            <span class="text-4xl font-extrabold text-slate-900">Rp <?php echo e(number_format($plan['price']/1000)); ?>rb</span>
                        <?php endif; ?>
                        <span class="text-slate-500 font-medium">/ <?php echo e($plan['period'] ?? 'bulan'); ?></span>
                    </div>
                    
                    <p class="text-slate-500 mb-8 text-sm"><?php echo e($plan['description']); ?></p>

                    <ul class="space-y-4 mb-8 flex-1">
                        <?php $__currentLoopData = $plan['features']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="flex items-start gap-3 text-sm <?php echo e($feature['included'] ? 'text-slate-700' : 'text-slate-400 line-through'); ?>">
                    ...
                    <a href="<?php echo e(route('register.tenant', ['package' => $plan['id']])); ?>" class="w-full py-4 rounded-xl font-bold text-center transition-all <?php echo e($plan['is_featured'] ? 'bg-indigo-600 text-white hover:bg-indigo-700 shadow-lg hover:shadow-indigo-500/30' : 'bg-slate-50 text-slate-700 hover:bg-slate-100 border border-slate-200'); ?>">
    ...
    <footer class="bg-slate-900 text-slate-300 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="pt-8 border-t border-slate-800 text-center text-sm text-slate-500">
                &copy; <?php echo e(date('Y')); ?> SANTRIX by Velora. All rights reserved. Made with ❤️ for Pesantren Indonesia.
            </div>
        </div>
    </footer>
