...
<?php $__env->startSection('subtitle', 'Here is what\'s happening with your tenants today.'); ?>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow relative overflow-hidden group">
        ...
        <div>
            ...
            <p class="text-3xl font-bold text-slate-800 mt-1">Rp <?php echo e(number_format($revenue ?? 0, 0, ',', '.')); ?></p>
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow relative overflow-hidden group">
        ...
        <div>
            ...
            <p class="text-3xl font-bold text-slate-800 mt-1"><?php echo e($total); ?></p>
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow relative overflow-hidden group">
        ...
        <div>
            ...
            <p class="text-3xl font-bold text-slate-800 mt-1"><?php echo e($active); ?></p>
             <div class="flex items-center mt-2 text-xs font-medium text-emerald-600">
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow relative overflow-hidden group">
        ...
        <div>
            ...
            <p class="text-3xl font-bold text-slate-800 mt-1"><?php echo e($expiring); ?></p>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
    <div class="lg:col-span-3 bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="<?php echo e(route('owner.pesantren.index')); ?>" class="text-sm font-medium text-indigo-600 hover:text-indigo-700">View All</a>
        </div>
...
<?php echo $__env->make('owner.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\v\.gemini\antigravity\scratch\santrix\resources\views\owner\dashboard\index.blade.php ENDPATH**/ ?>