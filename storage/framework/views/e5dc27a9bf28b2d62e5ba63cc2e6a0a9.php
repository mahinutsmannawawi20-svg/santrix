...
<head>
    ...
    <title>Daftar SANTRIX - <?php echo e($selectedPlan['name'] ?? 'Paket'); ?></title>
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-indigo-600 to-violet-600 px-8 py-10 text-white">
                ...
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <span class="font-semibold"><?php echo e($selectedPlan['name']); ?> - <?php echo e($selectedPlan['duration_months']); ?> Bulan</span>
                </div>
                
                <h1 class="text-3xl font-bold mb-3">Buat Akun Pesantren</h1>
                <p class="text-indigo-100">Dapatkan akses <strong class="text-white">trial <?php echo e($trialDays); ?> hari gratis</strong> untuk mencoba semua fitur</p>
            ...
            <div class="p-8">
                ...
                <form action="<?php echo e(route('register.tenant.store')); ?>" method="POST" class="space-y-8">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <div class="space-y-5">
                            <div>
                                ...
                                <input type="text" name="nama_pesantren" value="<?php echo e(old('nama_pesantren')); ?>" 
                                ...
                                <?php $__errorArgs = ['nama_pesantren'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php if(str_starts_with($package, 'advance')): ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <button type="submit" class="w-full bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-700 hover:to-violet-700 text-white font-bold py-4 rounded-xl transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2">
                        ...
                        Buat Akun & Mulai Trial <?php echo e($trialDays); ?> Hari
                    </button>

                    <p class="text-center text-sm text-slate-600">
                        Sudah punya akun? <a href="<?php echo e(route('login')); ?>" class="text-indigo-600 font-semibold hover:underline">Masuk disini →</a>
                    </p>
                </form>
            </div>
        </div>
...
<?php /**PATH C:\Users\v\.gemini\antigravity\scratch\santrix\resources\views\auth\register-tenant.blade.php ENDPATH**/ ?>