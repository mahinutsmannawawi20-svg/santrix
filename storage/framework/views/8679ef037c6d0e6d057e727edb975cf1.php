...
<?php $__env->startSection('content'); ?>
    ...
    <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 16px; padding: 24px 32px; margin-bottom: 24px; box-shadow: 0 10px 30px rgba(102, 126, 234, 0.3); position: relative; overflow: hidden;">
        ...
        <div style="display: flex; align-items: center; justify-content: space-between; position: relative; z-index: 1; margin-bottom: 20px;">
            ...
            <form id="form-reset-va-bulk" action="<?php echo e(route('santri.reset-va-bulk')); ?>" method="POST" style="display: none;">
                <?php echo csrf_field(); ?>
            </form>
        </div>
                    ...
                    <tr style="border-bottom: 1px solid #f3f4f6; transition: background 0.2s;" onmouseover="this.style.background='#f9fafb';" onmouseout="this.style.background='white';">
                        ...
                        <td style="padding: 12px 16px; text-align: center;">
                            <div style="display: flex; gap: 6px; justify-content: center;">
                                ...
                                <?php if($s->is_active): ?>
                                    <form method="POST" action="<?php echo e(route('sekretaris.data-santri.deactivate', $s->id)); ?>" style="display: inline;" onsubmit="return confirmDelete(event, 'Santri ini akan dinonaktifkan dan tidak bisa login lagi.', 'Nonaktifkan Santri?')">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\v\.gemini\antigravity\scratch\santrix\resources\views/sekretaris/data-santri/index.blade.php ENDPATH**/ ?>