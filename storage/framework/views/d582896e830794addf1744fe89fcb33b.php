...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> - SANTRIX</title>
...
<body>
    ...
    <aside class="sidebar">
        <div class="sidebar-logo" style="display: flex; align-items: center; gap: 12px;">
            <img src="<?php echo e(tenant_logo()); ?>" alt="Logo" style="width: 32px; height: 32px; object-fit: contain;">
        ...
        <div style="position: absolute; bottom: 0; width: 100%; padding: 24px; border-top: 1px solid rgba(255,255,255,0.05);">
            <div style="font-size: 12px; color: #718096;">
                &copy; <?php echo e(date('Y')); ?> SANTRIX
                <br>
...
<?php /**PATH C:\Users\v\.gemini\antigravity\scratch\santrix\resources\views/layouts/app.blade.php ENDPATH**/ ?>