                            ...
                            <tr id="row-<?php echo e($p->id); ?>" style="border-bottom: 1px solid #f1f5f9; transition: background 0.2s;">
                                ...
                                <td style="padding: 16px 24px; text-align: center;">
                                    <div style="display: flex; justify-content: center; gap: 8px;">
                                        ...
                                        <form method="POST" action="<?php echo e(route('bendahara.pemasukan.destroy', $p->id)); ?>" style="display: inline;" onsubmit="return confirmDelete(event, 'Data pemasukan ini akan dihapus.')">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\v\.gemini\antigravity\scratch\santrix\resources\views\bendahara\pemasukan\index.blade.php ENDPATH**/ ?>