...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> - Santrix Owner</title>
    ...
    <div class="min-h-screen flex">
        ...
        <aside class="w-72 bg-slate-900 text-white flex flex-col shadow-xl z-20">
            ...
            <nav class="flex-1 px-4 py-8 space-y-2">
                ...
                <a href="<?php echo e(route('owner.dashboard')); ?>" class="group flex items-center px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('owner.dashboard') ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-900/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white'); ?>">
                    <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('owner.dashboard') ? 'text-white' : 'text-slate-500 group-hover:text-white'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('owner.pesantren.index')); ?>" class="group flex items-center px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('owner.pesantren.*') ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-900/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white'); ?>">
                    <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('owner.pesantren.*') ? 'text-white' : 'text-slate-500 group-hover:text-white'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                    </svg>
                    <span class="font-medium">Data Pesantren</span>
                </a>

                <a href="<?php echo e(route('owner.withdrawal.index')); ?>" class="group flex items-center px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('owner.withdrawal.*') ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-900/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white'); ?>">
                    <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('owner.withdrawal.*') ? 'text-white' : 'text-slate-500 group-hover:text-white'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('owner.logs')); ?>" class="group flex items-center px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('owner.logs') ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-900/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white'); ?>">
                    <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('owner.logs') ? 'text-white' : 'text-slate-500 group-hover:text-white'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="p-4 border-t border-slate-800">
                 <div class="bg-slate-800 rounded-xl p-4 flex items-center justify-between mb-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-medium text-white"><?php echo e(Auth::user()->name ?? 'Super Owner'); ?></p>
        ...
        <main class="flex-1 flex flex-col relative overflow-hidden bg-gray-50/50">
            ...
            <header class="h-20 bg-white/80 backdrop-blur-md border-b border-gray-200/50 flex items-center justify-between px-8 sticky top-0 z-10 w-full">
                <div>
                    ...
                    <p class="text-sm text-slate-500 mt-1"><?php echo $__env->yieldContent('subtitle', 'Welcome back, Owner!'); ?></p>
                </div>
                <div class="flex items-center space-x-6">
                    ...
                    <div class="h-8 w-px bg-gray-200"></div>
                     <span class="text-sm font-medium text-slate-600"><?php echo e(now()->format('l, d F Y')); ?></span>
                </div>
            </header>
