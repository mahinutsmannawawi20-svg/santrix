...
<script>
    ...
    function fetchTargets() {
        ...
        fetch("<?php echo e(route('bendahara.billing.targets')); ?>")
    ...
    function processNextBilling() {
        ...
        // Send Request
        fetch("<?php echo e(route('bendahara.billing.send')); ?>", {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\v\.gemini\antigravity\scratch\santrix\resources\views\bendahara\cek-tunggakan\index.blade.php ENDPATH**/ ?>