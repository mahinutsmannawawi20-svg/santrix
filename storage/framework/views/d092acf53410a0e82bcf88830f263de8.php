...
<li class="sidebar-menu-item">
    <a href="<?php echo e(route('admin.activity-log')); ?>" class="sidebar-menu-link <?php echo e(request()->routeIs('admin.activity-log') ? 'active' : ''); ?>">
        <i data-feather="activity" class="sidebar-menu-icon"></i>
        <span>Riwayat Aktivitas</span>
    </a>
</li>
<li class="sidebar-menu-item">
    <a href="<?php echo e(route('admin.pengaturan')); ?>" class="sidebar-menu-link <?php echo e(request()->routeIs('admin.pengaturan*') ? 'active' : ''); ?>">
        <i data-feather="settings" class="sidebar-menu-icon"></i>
        <span>Pengaturan</span>
    </a>
</li>
<li class="sidebar-menu-item">
    <a href="<?php echo e(route('admin.billing.index')); ?>" class="sidebar-menu-link <?php echo e(request()->routeIs('admin.billing.*') ? 'active' : ''); ?>">
        <i data-feather="credit-card" class="sidebar-menu-icon"></i>
        <span>Billing & Langganan</span>
    </a>
</li>
<li class="sidebar-menu-item">
    <a href="<?php echo e(route('admin.withdrawal.index')); ?>" class="sidebar-menu-link <?php echo e(request()->routeIs('admin.withdrawal.*') ? 'active' : ''); ?>">
        <i data-feather="download" class="sidebar-menu-icon"></i>
        <span>Tarik Dana</span>
    </a>
</li>
<li class="sidebar-menu-item">
    <a href="<?php echo e(route('admin.settings.pesantren')); ?>" class="sidebar-menu-link <?php echo e(request()->routeIs('admin.settings.pesantren*') ? 'active' : ''); ?>">
...
<li class="sidebar-menu-item" style="margin-top: 16px;">
    <a href="<?php echo e(route('backup.download')); ?>" class="sidebar-menu-link" style="background: rgba(34, 197, 94, 0.1); border: 1px solid rgba(34, 197, 94, 0.3);">
...
<?php /**PATH C:\Users\v\.gemini\antigravity\scratch\santrix\resources\views\admin\partials\sidebar-menu.blade.php ENDPATH**/ ?>