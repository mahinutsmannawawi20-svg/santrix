...
<head>
    ...
    <title>Statistik Santri per Asrama - <?php echo e(tenant_name()); ?></title>
    <style>
        body {
...
<body>
    ...
    <p class="subtitle"><?php echo e(tenant()->nama ?? 'Yayasan Pondok Pesantren'); ?></p>
    ...
    <div class="footer">
        ...
        <p>Dashboard <?php echo e(tenant_name()); ?> - Sistem Informasi Pondok Pesantren</p>
    </div>
</body>
</html>
<?php /**PATH C:\Users\v\.gemini\antigravity\scratch\santrix\resources\views\sekretaris\laporan\statistik-asrama-pdf.blade.php ENDPATH**/ ?>