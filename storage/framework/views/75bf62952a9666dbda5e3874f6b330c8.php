...
<?php $__env->startSection('title', 'Detail Tagihan - ' . $invoice->invoice_number); ?>
<?php $__env->startSection('page-title', 'Detail Tagihan'); ?>
...
<div style="padding: 24px; max-w-900px; margin: 0 auto;">
    ...
    <!-- Back Button -->
    <a href="<?php echo e(route('admin.billing.index')); ?>" style="display: inline-flex; align-items: center; gap: 8px; color: #64748b; text-decoration: none; font-weight: 600; margin-bottom: 20px; transition: color 0.2s;" onmouseover="this.style.color='#1e293b'" onmouseout="this.style.color='#64748b'">
    ...
    <div style="background: white; border-radius: 20px; box-shadow: 0 4px 20px rgba(0,0,0,0.05); overflow: hidden;">
        ...
        <!-- Header -->
        <div style="background: <?php echo e($statusConfig['gradient']); ?>; padding: 32px; color: white; position: relative; overflow: hidden;">
            ...
            <div style="position: relative; z-index: 1;">
                ...
                <div style="display: inline-flex; align-items: center; gap: 8px; background: rgba(255,255,255,0.2); padding: 8px 16px; border-radius: 999px; margin-bottom: 16px; backdrop-filter: blur(4px); border: 1px solid rgba(255,255,255,0.3);">
                    <i data-feather="<?php echo e($statusConfig['icon']); ?>" style="width: 16px; height: 16px;"></i>
                    <span style="font-size: 0.875rem; font-weight: 700;"><?php echo e($statusConfig['label']); ?></span>
                </div>

                <div style="display: flex; justify-content: space-between; align-items: end; flex-wrap: wrap; gap: 20px;">
                    <div>
                        <h1 style="font-size: 2.5rem; font-weight: 800; margin: 0 0 8px 0; color: white !important;"><?php echo e($invoice->invoice_number); ?></h1>
                        <p style="color: rgba(255,255,255,0.9) !important; font-size: 0.875rem; margin: 0; font-weight: 500;">
                            Tanggal: <?php echo e($invoice->created_at->format('d F Y, H:i')); ?> WIB
                        </p>
                    </div>
                    ...
                    <div style="text-align: right;">
                        ...
                        <div style="font-size: 2.5rem; font-weight: 800; color: white !important;">Rp <?php echo e(number_format($invoice->amount, 0, ',', '.')); ?></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div style="padding: 32px;">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 24px; margin-bottom: 32px;">
                <div>
                    ...
                    <div style="font-size: 1.5rem; font-weight: 800; color: #1e293b; margin-bottom: 4px;"><?php echo e($invoice->pesantren->nama); ?></div>
                    <div style="color: #64748b; font-weight: 600;"><?php echo e($invoice->pesantren->subdomain); ?>.santrix.my.id</div>
                </div>
                ...
                <div>
                    ...
                    <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
                        ...
                        <span style="font-weight: 700; color: #1e293b;"><?php echo e($invoice->period_start->format('d M Y')); ?> - <?php echo e($invoice->period_end->format('d M Y')); ?></span>
                    </div>
                    ...
                    <tbody>
                        <tr>
                            <td style="padding: 24px 20px;">
                                <div style="display: flex; align-items: center; gap: 12px;">
                                    ...
                                    <div>
                                        <div style="font-size: 1.125rem; font-weight: 700; color: #0f172a;">Paket <?php echo e(strtoupper($invoice->subscription->package_name ?? 'Unknown')); ?></div>
                            ...
                            <td style="padding: 24px 20px; text-align: right;">
                                <div style="font-size: 1.5rem; font-weight: 800; color: #0f172a;">Rp <?php echo e(number_format($invoice->amount, 0, ',', '.')); ?></div>
                            </td>
                        </tr>
                        <tr style="background: #e2e8f0;">
                            ...
                            <td style="padding: 16px 20px; text-align: right;">
                                <div style="font-size: 2rem; font-weight: 800; color: #6366f1;">Rp <?php echo e(number_format($invoice->amount, 0, ',', '.')); ?></div>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                document.getElementById('pay-button').onclick = function(){
                    ...
                    snap.pay('<?php echo e($snapToken); ?>', {
                        ...
                        onSuccess: function(result){
                            ...
                            // console.log(result);
                            window.location.href = "<?php echo e(route('admin.billing.pay', $invoice->id)); ?>?transaction_status=settlement";
                        },
            ...
            <div style="background: #ecfdf5; border: 2px solid #a7f3d0; border-radius: 12px; padding: 24px;">
                <div style="display: flex; align-items: center; gap: 16px; flex-wrap: wrap;">
                    ...
                    <div style="flex: 1;">
                        ...
                        <p style="color: #047857; font-weight: 600; margin: 0;">Invoice ini telah dibayar pada <strong><?php echo e($invoice->paid_at?->format('d M Y, H:i') ?? $invoice->updated_at->format('d M Y, H:i')); ?></strong></p>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\v\.gemini\antigravity\scratch\santrix\resources\views\billing\show.blade.php ENDPATH**/ ?>