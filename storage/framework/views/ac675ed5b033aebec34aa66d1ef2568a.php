...
<?php $__env->startSection('content'); ?>
    ...
    <div style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); border-radius: 16px; padding: 24px 32px; margin-bottom: 24px; box-shadow: 0 10px 30px rgba(79, 172, 254, 0.3); position: relative; overflow: hidden;">
        ...
        <div style="display: flex; align-items: center; gap: 16px; position: relative; z-index: 1;">
            ...
            <div>
                <h2 style="font-size: 1.5rem; font-weight: 700; color: white; margin: 0 0 4px 0;">Assalamualaikum <?php echo e(ucwords(str_replace('_', ' ', auth()->user()->role))); ?> <?php echo e(auth()->user()->pesantren->nama ?? ''); ?></h2>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\v\.gemini\antigravity\scratch\santrix\resources\views\pendidikan\dashboard\index.blade.php ENDPATH**/ ?>